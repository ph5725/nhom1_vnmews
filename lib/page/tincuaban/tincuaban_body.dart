...
Widget tinCuaBanBody(TinTucModel item, BuildContext context) {
  // Hàm xử lý mở URL
  ...
  return Column(
    ...
    children: [
      InkWell(
        onTap: () => openUrl(item.urlNoiDung, context),
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  if (item.nguon != null)
                    Image.network(item.nguon!, width: 40, height: 20, fit: BoxFit.contain,),
