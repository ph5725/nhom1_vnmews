...
class NongWidget extends StatefulWidget {
  const NongWidget({super.key});

  @override
  State<NongWidget> createState() => _NongWidgetState();
}

class _NongWidgetState extends State<NongWidget> {
  late Future<List<TinTucModel>> ttList;

  @override
  void initState() {
    super.initState();
    ttList = RDNong().loadData();
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const Text("Nóng", style: titleStyle),
