...
class PhapLuatWidget extends StatefulWidget {
  ...
  @override
  State<PhapLuatWidget> createState() => _PhapLuatWidgetState();
}

class _PhapLuatWidgetState extends State<PhapLuatWidget> {
  late Future<List<TinTucModel>> ttList;

  @override
  void initState() {
    super.initState();
    ttList = RDPhapLuat().loadData();
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const Text( "Pháp Luật", style: titleStyle),
