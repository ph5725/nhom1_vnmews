...
class SucKhoeWidget extends StatefulWidget {
  const SucKhoeWidget({super.key});

  @override
  State<SucKhoeWidget> createState() => _SucKhoeWidgetState();
}

class _SucKhoeWidgetState extends State<SucKhoeWidget> {
  late Future<List<TinTucModel>> ttList;

  @override
  void initState() {
    super.initState();
    ttList = RDSucKhoe().loadData();
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const Text("Sức Khỏe", style: titleStyle),
