...
class DuLichWidget extends StatefulWidget {
  const DuLichWidget({super.key});

  @override
  State<DuLichWidget> createState() => _DuLichWidgetState();
}

class _DuLichWidgetState extends State<DuLichWidget> {
  late Future<List<TinTucModel>> ttList;

  @override
  void initState() {
    super.initState();
    ttList = RDDuLich().loadData();
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const Text("Du Lịch", style: titleStyle),
