...
class TheGioiXeWidget extends StatefulWidget {
  const TheGioiXeWidget({super.key});

  @override
  State<TheGioiXeWidget> createState() => _TheGioiXeWidgetState();
}

class _TheGioiXeWidgetState extends State<TheGioiXeWidget> {
  late Future<List<TinTucModel>> ttList;

  @override
  void initState() {
    super.initState();
    ttList = RDTheGioiXe().loadData();
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const Text("Thế Giới Xe", style: titleStyle),
