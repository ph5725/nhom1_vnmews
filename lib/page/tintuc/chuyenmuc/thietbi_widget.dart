...
class ThietBiWidget extends StatefulWidget {
  const ThietBiWidget({super.key});

  @override
  State<ThietBiWidget> createState() => _ThietBiWidgetState();
}

class _ThietBiWidgetState extends State<ThietBiWidget> {
  late Future<List<TinTucModel>> ttList;

  @override
  void initState() {
    super.initState();
    ttList = RDThietBi().loadData();
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const Text( "Thiết Bị", style: titleStyle),
