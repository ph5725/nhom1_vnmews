...
class CongNgheWidget extends StatefulWidget {
  const CongNgheWidget({super.key});

  @override
  State<CongNgheWidget> createState() => _CongNgheWidgetState();
}

class _CongNgheWidgetState extends State<CongNgheWidget> {
  late Future<List<TinTucModel>> ttList;

  @override
  void initState() {
    super.initState();
    ttList = RdCongNghe().loadData();
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const Text("Công Nghệ", style: titleStyle),
