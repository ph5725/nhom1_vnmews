...
class TheThaoWidget extends StatefulWidget {
  const TheThaoWidget({super.key});

  @override
  State<TheThaoWidget> createState() => _TheThaoWidgetState();
}

class _TheThaoWidgetState extends State<TheThaoWidget> {
  late Future<List<TinTucModel>> ttList;

  @override
  void initState() {
    super.initState();
    ttList = RDTheThao().loadData();
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const Text( "Thể Thao", style: titleStyle),
