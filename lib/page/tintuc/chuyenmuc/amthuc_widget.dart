...
class AmThucWidget extends StatefulWidget {
  const AmThucWidget({super.key});

  @override
  State<AmThucWidget> createState() => _AmThucWidgetState();
}

class _AmThucWidgetState extends State<AmThucWidget> {
  late Future<List<TinTucModel>> ttList;

  @override
  void initState() {
    super.initState();
    ttList = RDAmThuc().loadData();
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const Text("Ẩm Thực", style: titleStyle),
