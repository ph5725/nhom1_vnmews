...
class TheGioiWidget extends StatefulWidget {
  ...
  @override
  State<TheGioiWidget> createState() => _TheGioiWidgetState();
}

class _TheGioiWidgetState extends State<TheGioiWidget> {
  late Future<List<TinTucModel>> ttList;

  @override
  void initState() {
    super.initState();
    ttList = RDTheGioi().loadData();
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const Text( "Thế Giới", style: titleStyle),
