...
class ThoiTrangWidget extends StatefulWidget {
  const ThoiTrangWidget({super.key});

  @override
  State<ThoiTrangWidget> createState() => _ThoiTrangWidgetState();
}

class _ThoiTrangWidgetState extends State<ThoiTrangWidget> {
  late Future<List<TinTucModel>> ttList;

  @override
  void initState() {
    super.initState();
    ttList = RDThoiTrang().loadData();
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const Text( "Thời Trang", style: titleStyle),
