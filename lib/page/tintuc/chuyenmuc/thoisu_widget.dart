...
class ThoiSuWidget extends StatefulWidget {
  const ThoiSuWidget({super.key});

  @override
  State<ThoiSuWidget> createState() => _ThoiSuWidgetState();
}

class _ThoiSuWidgetState extends State<ThoiSuWidget> {
  late Future<List<TinTucModel>> ttList;

  @override
  void initState() {
    super.initState();
    ttList = RDThoiSu().loadData();
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const Text("Thời Sự", style: titleStyle),
